...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EventBus processing");
    
    let mut processor = EventBusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EventBusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EventBusProcessor::new(false);
